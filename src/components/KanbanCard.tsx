...
export default function KanbanCard({
  ...
  const { permissions } = useAuth(); // ✅ Permissions check
  ...
  return (
    <div
      ...
      className={`bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-sm hover:shadow-lg dark:hover:border-indigo-500/50 transition-all group relative ${
        canDrag
