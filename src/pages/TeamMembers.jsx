            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <img
                  src={user.image}
                  alt={user.username}
                  className="w-14 h-14 rounded-full border-2 border-slate-100 dark:border-slate-700 group-hover:border-indigo-500 transition-colors"
                />
    ...
    <div className="text-slate-900 dark:text-white">
      <div className="flex items-center gap-5 mb-8">
        <img
          src={user.image}
          alt={user.username}
          className="w-20 h-20 rounded-2xl border-2 border-slate-100 dark:border-slate-800 shadow-sm"
        />
        <div>
      ...
      <div className="grid gap-4">
        ...
        <DetailItem icon={<Building2 size={18} />} label="Company" value={user.company?.name} />
        <DetailItem icon={<UserCircle2 size={18} />} label="Role" value="Team Member" />
      </div>
